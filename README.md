...
docker build .
docker login
docker tag bc7927b21e0d adnanmoussa/computational-workflows-homework
docker push adnanmoussa/computational-workflows-homework
```
...
```
docker run -it -v $pwd/root/shared -w /root/shared adnanmoussa/computational-workflows-homework
```
...
```
docker cp wallet.py 86a8a7083b8a:root/shared
docker cp test_wallet.py 86a8a7083b8a:root/shared
git add *.py
gti commit -m "upload py filesss"
```
